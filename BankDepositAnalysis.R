...
# <chr> <dbl> <chr> <chr>   <chr>     <chr>     <dbl> <chr>   <chr> <chr>   <dbl> <chr>    <dbl>
#   1 2836     58 mana… married tertiary  no         2143 yes     no    unknown     5 may        261
#  2 2837     44 tech… single  secondary no           29 yes     no    unknown     5 may        151
#  3 2838     33 entr… married secondary no            2 yes     yes   unknown     5 may         76
#  4 2839     47 blue… married unknown   no         1506 yes     no    unknown     5 may         92
#  5 2840     33 unkn… single  unknown   no            1 no      no    unknown     5 may        198
#  6 2841     35 mana… married tertiary  no          231 yes     no    unknown     5 may        139
#  7 2842     28 mana… single  tertiary  no          447 yes     yes   unknown     5 may        217
#  8 2843     42 entr… divorc… tertiary  yes           2 yes     no    unknown     5 may        380
#  9 2844     58 reti… married primary   no          121 yes     no    unknown     5 may         50
# 10 2845     43 tech… single  secondary no          593 yes     no    unknown     5 may         55
# … with 45,201 more rows, and 5 more variables: CAMPAIGN <dbl>, PDAYS <dbl>, PREVIOUS <dbl>,
#   POUTCOME <chr>, TERM_DEPOSIT <chr>
...
#  1      1 step      rm         TRUE    FALSE rm_Kld63        
#  2      2 step      discretize TRUE    FALSE discretize_SWp71
#  3      3 step      dummy      TRUE    FALSE dummy_AxOqU     
